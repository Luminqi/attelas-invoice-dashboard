      ...
      <DialogContent className="sm:max-w-md max-w-[90%] max-h-[90%] overflow-y-auto">
        ...
        <div className="space-y-6 text-left text-sm">
          ...
          <div className="space-y-4">
            <div>Dear {name},</div>
            <div>
              I hope this email finds you well. I am writing to remind you about
              the outstanding payment for invoice number {invoice.invoiceNumber}
              .
            </div>
            ...
            <div>
              We kindly request that you process this payment at your earliest
              convenience. If you have already made the payment, please
              disregard this reminder and accept our thanks.
            </div>
            <div>
            ...
            <div>
              Thank you for your prompt attention to this matter. We value your
              business and look forward to continuing our professional
              relationship.
            </div>
